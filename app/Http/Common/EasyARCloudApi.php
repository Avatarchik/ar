...
class EasyARCloudApi
{
    ...
    public
    function curlHttpGetRequest($host, $router, $id = '')
    {
        if ('' == $id) {
            $url = $host . '/' . $router . '/';
        } else {
    ...
    public
    function curlHttpPostRequest($host, $router, $data)
    {
        $url = $host . '/' . $router . '/';
    ...
    public
    function curlHttpPutRequest($host, $router, $id, $data)
    {
        $url = $host . '/' . $router . '/' . $id;
    ...
    public
    function curlHttpDeleteRequest($host, $router, $id, $data)
    {
        $url = $host . '/' . $router . '/' . $id;
    ...
    {
        $timestamp = time();
        echo date('Y-m-d\TH:i:s.000\Z', $timestamp);
