...
Route::group(['prefix' => 'manage', 'middleware' => ['manage']], function () {
    ...
    Route::group(['prefix' => 'ar'], function () {
        ...
        Route::get('/', function () {
            return Redirect::to('/manage/ar/marked');
        });
        Route::get('/marked', 'Manage\ARMarkedController@index', ['model' => 'ar', 'menu' => 'marked']);
        Route::get('/marked/create', 'Manage\ARMarkedController@getCreate', ['model' => 'ar', 'menu' => 'marked']);
        Route::post('/marked/create', 'Manage\ARMarkedController@postCreate', ['model' => 'ar', 'menu' => 'marked']);

        Route::get('/resources', 'Manage\ARResourcesController@index', ['model' => 'ar', 'menu' => 'resources']);
        Route::get('/resources/create', 'Manage\ARResourcesController@getCreate', ['model' => 'ar', 'menu' => 'resources']);
        Route::post('/resources/create', 'Manage\ARResourcesController@postCreate', ['model' => 'ar', 'menu' => 'resources']);

        Route::get('/report ', 'Manage\ARController@report', ['model' => 'ar', 'menu' => 'marked']);

        Route::get('/apply', 'Manage\ARController@apply', ['model' => 'ar', 'menu' => 'marked']);
