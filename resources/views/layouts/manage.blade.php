...
<head>
    ...
    <title>AR资源管理平台@yield('title')</title>
    ...
    <div class="page-header">
        ...
        <div class="page-header-nav">
            ...
            <div class="page-header-nav-menu">
                <a href="/manage/ar/" <?php echo(isset($model) && $model === 'ar' ? ' class="active"' : '');?>>资源中心</a>
                <a href="/manage/system/" <?php echo(isset($model) && $model === 'system' ? ' class="active"' : '');?>>系统设置</a>
        ...
        @if(isset($model))
            @if($model=='ar')
                <div class="page-content-side">
                    <div class="page-content-side-nav">AR资源管理</div>
                    <div class="page-content-side-menu">
                        <a href="/manage/ar/marked/">识别图管理</a>
                        <a href="/manage/ar/resources/">资源管理</a>
                        <a href="/manage/ar/report/">资源统计</a>
                        <a href="/manage/ar/apply/">应用分析</a>
                    </div>
                </div>
            @endif
            @if($model=='system')
